            ...
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div ref={searchbar} className="items-center hidden justify-between w-full md:flex md:w-auto md:order-1">
                    <div className="relative mt-3 md:hidden">
                        ...
                        <input type="text" id="search-navbar-md" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." />
                    </div>
                </div>
